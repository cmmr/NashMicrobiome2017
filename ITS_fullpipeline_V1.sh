...
#merge both reads
cat ${READSDIR}/../SampleList | parallel -j${THREADS} -I {} "echo '{} Merge:'; usearch81 -fastq_mergepairs ${TMPDIR}/{}.1.fq -reverse ${TMPDIR}/{}.2.fq -fastq_allowmergestagger -fastq_minovlen 50 -fastqout ${TMPDIR}/{}.Merged.fq; echo";
...
cat ${READSDIR}/../SampleList | parallel -j$THREADS -I {} "echo {}; usearch70 -fastq_filter ${TMPDIR}/{}.Merged.fq -fastqout ${TMPDIR}/{}.FilteredRaw.fq -eeout -fastq_minlen 200";
cat ${READSDIR}/../SampleList | parallel -j$THREADS -I {} "echo {}; usearch70 -fastq_filter ${TMPDIR}/{}.Merged.fq -relabel \"{}_\" -fastqout ${TMPDIR}/{}.Filtered.fq -eeout -fastq_minlen 200";
...
biom convert -i ${TMPDIR}/uparse{}/otu_table_merged.{}.biom -o ${READSDIR}/../../Deliverables/${PROJECTID}.otu_table_merged.{}.frombiom.txt -b --header-key taxonomy;
